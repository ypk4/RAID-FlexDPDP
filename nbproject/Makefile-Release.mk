...
${OBJECTDIR}/AuthenticatedNode.o: AuthenticatedNode.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AuthenticatedNode.o AuthenticatedNode.cpp

${OBJECTDIR}/AuthenticatedSkipList.o: AuthenticatedSkipList.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AuthenticatedSkipList.o AuthenticatedSkipList.cpp

${OBJECTDIR}/CashException.o: CashException.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CashException.o CashException.cpp

${OBJECTDIR}/Ciphertext.o: Ciphertext.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Ciphertext.o Ciphertext.cpp

${OBJECTDIR}/CommonFunctions.o: CommonFunctions.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CommonFunctions.o CommonFunctions.cpp

${OBJECTDIR}/DPDPFlexProver.o: DPDPFlexProver.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DPDPFlexProver.o DPDPFlexProver.cpp

${OBJECTDIR}/DPDPFlexVerifier.o: DPDPFlexVerifier.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DPDPFlexVerifier.o DPDPFlexVerifier.cpp
...
${OBJECTDIR}/FourSquares.o: FourSquares.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FourSquares.o FourSquares.cpp
...
${OBJECTDIR}/GroupRSA.o: GroupRSA.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GroupRSA.o GroupRSA.cpp
...
${OBJECTDIR}/Merkle.o: Merkle.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Merkle.o Merkle.cpp

${OBJECTDIR}/MultiExp.o: MultiExp.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MultiExp.o MultiExp.cpp

${OBJECTDIR}/NTL/ZZ.o: NTL/ZZ.cpp
	${MKDIR} -p ${OBJECTDIR}/NTL
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NTL/ZZ.o NTL/ZZ.cpp
...
${OBJECTDIR}/ProofNode.o: ProofNode.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ProofNode.o ProofNode.cpp

${OBJECTDIR}/RankBasedNode.o: RankBasedNode.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RankBasedNode.o RankBasedNode.cpp

${OBJECTDIR}/RankBasedSkipList.o: RankBasedSkipList.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RankBasedSkipList.o RankBasedSkipList.cpp

${OBJECTDIR}/Serialize.o: Serialize.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Serialize.o Serialize.cpp

${OBJECTDIR}/SkipList.o: SkipList.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SkipList.o SkipList.cpp
...
${OBJECTDIR}/build_challenge_prove_verify.o: build_challenge_prove_verify.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/build_challenge_prove_verify.o build_challenge_prove_verify.cpp

${OBJECTDIR}/build_flexlist.o: build_flexlist.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/build_flexlist.o build_flexlist.cpp

${OBJECTDIR}/check_daemon_existence.o: check_daemon_existence.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/check_daemon_existence.o check_daemon_existence.cpp

${OBJECTDIR}/create_daemon.o: create_daemon.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/create_daemon.o create_daemon.cpp

${OBJECTDIR}/get_mount_location.o: get_mount_location.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/get_mount_location.o get_mount_location.cpp
...
${OBJECTDIR}/mdstat_entry.o: mdstat_entry.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mdstat_entry.o mdstat_entry.cpp

${OBJECTDIR}/read_mdstat.o: read_mdstat.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/read_mdstat.o read_mdstat.cpp

${OBJECTDIR}/watch.o: watch.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/watch.o watch.cpp
