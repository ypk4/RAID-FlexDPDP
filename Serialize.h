 ...
 *     ar & stat;                   // serialize with no name (can't use with XML)
 *  }
 */
...
template <typename T> inline std::string saveString(const T & o) {
...
template <typename T> inline void loadString(T & o, const std::string& s) {
...
template <typename T> inline void saveXML(const T& o, const char* f) { 
	saveFile_<T,bar::xml_oarchive>(o, f); 
}
template <typename T> inline void saveBinary(const T& o, const char* f) {
	saveFile_<T,bar::binary_oarchive>(o, f); 
}
template <typename T> inline void saveFile(const T& o, const char* f) {
	saveFile_<T,bar::xml_oarchive>(o, f); 
}
template <typename T> inline void saveFile(const T& o, const char* n, const char* f) {
	saveFile_<T,bar::xml_oarchive>(make_nvp(n, o), f); 
}
template <typename T> inline void loadXML(T& o, const char* f) {
	loadFile_<T,bar::xml_iarchive>(o, f); 
}
template <typename T> inline void loadBinary(T& o, const char* f) {
	loadFile_<T,bar::binary_iarchive>(o, f); 
}
template <typename T> inline void loadFile(T& o, const char* f) {
	loadFile_<T,bar::xml_iarchive>(o, f); 
}
template <typename T> inline void loadFile(T& o, const char* n, const char* f) {
	loadFile_<T,bar::xml_iarchive>(make_nvp(n, o), f); 
}
template <typename T> inline void saveXMLGZ(const T& o, const char* f) {
	saveGZFile_<T,bar::xml_oarchive>(o, f); 
}

template <typename T> inline void saveGZ(const T& o, const char* f) {
	saveGZFile_<T,bar::binary_oarchive>(o, f); 
}
template <typename T> inline void loadXMLGZ(T& o, const char* f) {
	loadGZFile_<T,bar::xml_iarchive>(o, f); 
}
template <typename T> inline void loadGZ(T& o, const char* f) {
	loadGZFile_<T,bar::binary_iarchive>(o, f); 
}

template <typename T> inline void saveFile(const T & o, const std::string& f)
{ saveFile<T>(o, f.c_str()); }
template <typename T> inline void loadFile(T & o, const std::string& f)
{ loadFile<T>(o, f.c_str()); }

//template <typename T> inline void saveFile(const T & o, const char* n, const std::string& f)
//{ saveFile_<T,bar::xml_oarchive>(make_nvp(n, o), f.c_str()); }
//template <typename T> inline void loadFile(T & o, const char* n, const std::string& f)
//{ loadFile_<T,bar::xml_iarchive>(make_nvp(n, o), f.c_str()); }

template <typename T> inline void saveXML(const T & o, const std::string& f)
{ saveFile_<T,bar::xml_oarchive>(o, f.c_str()); }
template <typename T> inline void loadXML(T & o, const std::string& f)
{ loadFile_<T,bar::xml_iarchive>(o, f.c_str()); }
